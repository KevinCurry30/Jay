...
import com.diligroup.utils.CitycodeUtil;
...
//	private static ArrayList<String> couny_list_code = new ArrayList<String>();
    ...
    private String count_code_string;
    ...
    protected void onFinishInflate() {
        ...
        provincePicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
            ...
            public void endSelect(int id, String text) {
                ...
                provinceCode=citycodeUtil.getProvince_list_code().get(id);
            ...
            public void selecting(int id, String text) {
                // TODO Auto-generated method stub
                System.out.println("selecting=====state===id====" + text);
            }
        });
        ...
        counyPicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
            ...
            public void endSelect(int id, String text) {
                // TODO Auto-generated method stub
//               String  counyId= citycodeUtil.getCouny_list_code().get(id);
                count_code_string = citycodeUtil.getCouny_list_code().get(id);
                System.out.println("counyId=counyId====counyId==" + count_code_string + text);
