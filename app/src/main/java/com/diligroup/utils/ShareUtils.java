...
import com.diligroup.dialog.ShareDialog;
...
public class ShareUtils implements ShareDialog.PlantFormClickLinstener {
    ...
    public ShareUtils(Activity activity, String fromUrl, String toUrl) {
